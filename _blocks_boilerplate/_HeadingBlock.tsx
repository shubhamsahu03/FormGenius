...
import {
  ...
  SelectTrigger,
  SelectValue,
} from "@/components/ui/select"; // Make sure this path is correct. If not, update it to the actual path where Select is defined, e.g.:
...
const propertiesValidateSchema = z.object({
  ...
  level: z.number().min(1).max(6), // Required, no default
  fontSize: z.enum(["small", "medium", "large", "x-large", "2x-large", "4x-large"]), // Required, no default
  fontWeight: z.enum(["normal", "bold", "bolder", "lighter"]), // Required, no default
});
